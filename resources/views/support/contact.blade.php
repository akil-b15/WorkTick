...
<div class="row" id="section_contact_list">
    <div class="col-md-12">
        <div class="card text-left">
            ...
            <div class="card-body">
                <div class="table-responsive">
                    <table id="contact_table" class="display table">
                        <thead>
                            <tr>
                                <th>#</th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    {{-- @can('contact') --}}
                                    <a @click="Edit_contact( {{ $contact}})" class="ul-link-action text-success"
                                        data-toggle="tooltip" data-placement="top" title="Edit">
                                        <i class="i-Edit"></i>
                                    </a>

                                    <a @click="Remove_contact( {{ $contact->id}})"
