...
<div class="breadcrumb">
    <h1>{{ __('translate.Edit_Job_application') }}</h1>
    <ul>
        <li><a href="/job_applications">{{ __('translate.Job_application') }}</a></li>
        <li>{{ __('translate.Edit_Job_application') }}</li>
    </ul>
</div>
...
<!-- begin::main-row -->
<div class="row" id="section_Job_application_Edit">
    <div class="col-lg-12 mb-3">
        <div class="card">

            <!--begin::form-->
            <form @submit.prevent="Edit_Job_application()">
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-4">
...
<script>
    ...
    var app = new Vue({
    el: '#section_Job_application_Edit',
    components: {
        vuejsDatepicker,
    ...
    methods: {
        ...
        //------------------------ Edit Job_application ---------------------------\\
        Edit_Job_application() {
            var self = this;
            self.SubmitProcessing = true;
            axios.put(`/job_applications/${self.job_application.id}`, {
                ...
                job_id: self.job_application.job_id,
                    ...
                    toastr.success('{{ __('translate.Editd_successfully') }}');
                    self.errors = {};
            })
            .catch(error => {
                self.SubmitProcessing = false;
