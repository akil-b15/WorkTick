...
<div class="breadcrumb">
    <h1>{{ __('translate.Job_on_boarding_List') }}</h1>
    <ul>
        <li>{{ __('translate.Job_on_boarding') }}</li>
        <li>{{ __('translate.Job_on_boarding_List') }}</li>
    </ul>
</div>
                            ...
                            <tr>
                                ...
                                <td>
                                    @if($job_application->stage == 1)
                                        <span class="badge badge-success m-2">{{ __('translate.Applied') }}</span>
                                    @elseif($job_application->stage == 2)
                                        <span class="badge badge-success m-2">{{ __('translate.Phone_Screen') }}</span>                                    
                                    @elseif($job_application->stage == 3)
                                        <span class="badge badge-success m-2">{{ __('translate.Interview') }}</span>
                                ...
                                <td>
                                    ...
                                    <a href="/job_on_boardings/{{$job_application->id}}" class="ul-link-action text-info"
