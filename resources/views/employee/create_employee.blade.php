...
<script>
    ...
    data: {
        ...
        employee: {
            ...
            firstname: "{{ isset($job_application) ? $job_application->first_name : '' }}",
            lastname:"{{ isset($job_application) ? $job_application->last_name : '' }}",
            country:"{{ isset($job_application) ? $job_application->country : '' }}",
            email:"{{ isset($job_application) ? $job_application->email : '' }}",
            gender:"{{ isset($job_application) ? $job_application->gender : '' }}",
            phone:"{{ isset($job_application) ? $job_application->phone : '' }}",
            birth_date:"{{ isset($job_application) ? $job_application->birth_date : '' }}",
            department_id:"",
            designation_id:"",
            office_shift_id:"",
            joining_date:"",
