    ...
    <div class="header-part-right">
        ...
        <div class="dropdown">
            <div class="user col align-self-end">
                <span class="cursor-pointer d-flex align-items-center" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true" id="userDropdown">
                    <span class="pr-2">{{ Auth::user()->username }}</span>
                    <img src="{{asset('assets/images/avatar/'.Auth::user()->avatar)}}" alt="" >
                </span>

                <div class="mt-3 dropdown-menu dropdown-menu-right" aria-labelledby="userDropdown">
